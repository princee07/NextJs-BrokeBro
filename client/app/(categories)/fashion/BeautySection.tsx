...
const BeautySection: React.FC = () => {
    return (
        <div className="w-full max-w-6xl mx-auto my-8 md:my-12 px-4 md:px-0">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-extrabold text-center mb-4 md:mb-6 text-[#3D375A]">Beauty</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
                {beauty.map((product, idx) => (
                    <Link
                        key={idx}
