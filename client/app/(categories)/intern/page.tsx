      ...
      <div className="pt-32 relative z-10">
        ...
        <section ref={heroRef} className="relative w-full flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto pt-12 pb-12 px-4 md:px-8 fade-in-up">
          ...
          <div className="flex-1 flex flex-col items-start gap-6 z-10 max-w-xl">
            <div className="relative h-20 md:h-24 w-full">
              {headings.map((text, index) => (
                <h1
                  key={index}
                  className={`absolute w-full text-4xl md:text-5xl font-extrabold text-black leading-tight transition-all duration-700 ease-in-out ${headingIndex === index ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5 pointer-events-none'
                    }`}
                >
                  {text}
                </h1>
          ...
          <div ref={heroImageRef} className="flex-1 flex items-center justify-center relative mt-12 md:mt-0 min-w-[320px] min-h-[400px] fade-in-up">
            ...
            <div className="absolute bottom-8 left-12 w-10 h-10 floating3 bg-purple-200 rounded-lg -rotate-45" />
            ...
            <div className="absolute -right-8 bottom-8 bg-white/80 backdrop-blur-md rounded-2xl shadow-lg px-6 py-4 flex flex-col items-center gap-1 border border-black/10 z-20 w-40">
              <div className="w-20 h-20 rounded-t-full overflow-hidden bg-blue-200/50">
        ...
        <section ref={featuresRef} className="w-full max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 my-16 px-4 md:px-0 fade-in-up">
          <div className="flex items-center gap-4 bg-white/80 backdrop-blur-md border border-black/10 rounded-2xl shadow-md px-6 py-4 w-full md:w-1/3">
            <span className="bg-purple-200/50 rounded-xl p-3"><svg width="24" height="24" viewBox="0 0 24 24" fill="#A78BFA"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" /></svg></span>
            <div>
          ...
          <div className="flex items-center gap-4 bg-white/80 backdrop-blur-md border border-black/10 rounded-2xl shadow-md px-6 py-4 w-full md:w-1/3">
            <span className="bg-blue-200/50 rounded-xl p-3"><svg width="24" height="24" viewBox="0 0 24 24" fill="#60A5FA"><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-8 12.5v-9l6 4.5-6 4.5z" /></svg></span>
            <div>
