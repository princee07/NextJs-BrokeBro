          ...
          {navCategories.map((category, index) => {
            ...
            return (
              ...
              >
                <Link
                  href={category.path}
                  className={`text-base font-extrabold tracking-wide uppercase text-black hover:text-orange-400 transition-colors ${
                    activeCategory === category.name ? "text-orange-400" : ""
                  } hidden md:block`}
